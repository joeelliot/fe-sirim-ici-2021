  ...
  <div style="margin-left: 20px; margin-right: 20px; margin-bottom: 20px;">
    <div>
      ...
      <div style="display: flex; flex-direction: row; width: 100%; justify-content: flex-start; align-items: center;">
        <!-- <el-button @click="()=>addFulfillment()" type="primary">Add STB</el-button> -->
        <el-button @click="()=>selectFulfillment()" type="primary">Upload STB</el-button>
        <el-button @click="()=>selectFulfillment2()" type="primary">Assign STB</el-button>
      ...
      <div style="display: flex; flex-direction: column; justify-content: flex-start; align-items: center;">
        <el-table
          ...
          <el-table-column
            ...
            width="160">
            <template slot-scope="scope">
              <span>{{ scope.row.companyId | companyUsername(companyUsers)}}</span>
            </template>
          </el-table-column>
          <el-table-column
            align="center"
    ...
    <el-dialog :title="mode === 'create' ? 'Create STB' : 'Edit STB'" :visible.sync="fulfillmentCreate" :before-close="resetForm">
    ...
    <el-dialog title="Delete STB" :visible.sync="fulfillmentDelete" :before-close="resetForm">
      <span slot="footer" class="dialog-footer">
        <el-button @click="resetForm">Cancel</el-button>
...
import { getFulfillments, countFulfillments, createFulfillment, uploadFulfillmentSTB, assignFulfillmentSTB, updateFulfillment, deleteFulfillment } from '@/api/fulfillment'
  ...
  methods: {
    ...
    async fileSelected(event) {
      ...
      if (this.select === 'upload') {
        await uploadFulfillmentSTB(formData)
      } else {
        await assignFulfillmentSTB(formData)
      }
      this.fetchData()
    },
    editFulfillment(row) {
