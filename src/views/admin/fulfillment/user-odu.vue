<template>
  <div style="margin-left: 20px; margin-right: 20px; margin-bottom: 20px;">
    ...
    <el-dialog title="Update ODU" :visible.sync="fulfillmentCreate" :before-close="resetForm">
    ...
    <el-dialog title="Update ODU" :visible.sync="fulfillmentCreate2" :before-close="resetForm">
      <el-form ref="currUser2" :model="currUser2" label-width="240px">
